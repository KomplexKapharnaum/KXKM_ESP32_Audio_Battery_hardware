...
F 2 "RF_Module:ESP32-WROOM-32" H 4550 2150 60  0001 C CNN
...
F 3 "" H 1550 4900 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text Label 8550 1700 0    60   ~ 12
SD_DO
Text Label 8550 1300 0    60   ~ 12
SD_DI
Text Label 8550 1200 0    60   ~ 12
SD_CS
Text Label 8550 1500 0    60   ~ 12
SD_SCK
NoConn ~ 8900 1100
NoConn ~ 8900 1800
$Comp
...
F 3 "" H 10650 2050 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text Label 7550 2650 2    60   ~ 12
SD_CS
Text Label 7550 2850 2    60   ~ 12
SD_DI
Text Label 7550 2950 2    60   ~ 12
SD_SCK
Text Label 7550 3050 2    60   ~ 12
SD_DO
$Comp
...
NoConn ~ 6350 4250
NoConn ~ 4550 2450
Text Notes 8650 2250 0    60   ~ 12
P/N : 112J-TDAR-R01 / TFP09-2-12B
$Comp
L KXKM_audio_battery_module-rescue:GND #PWR0127
U 1 1 5CA3FB9A
P 4000 5550
...
LED_DATA_1
$Comp
L KXKM_audio_battery_module-rescue:+3.3V #PWR0128
U 1 1 5CA40497
P 3100 4550
...
Wire Wire Line
	3100 4600 3200 4600
$Comp
L KXKM_audio_battery_module-rescue:+BATT #PWR0103
U 1 1 5CB8685A
P 4050 4550
...
$EndComp
$Comp
L KXKM_audio_battery_module-rescue:VBUS #PWR0104
U 1 1 5CB8B602
P 2850 4550
...
Wire Wire Line
	3700 5500 4000 5500
Text Notes 7800 2400 0    60   ~ 12
ToDo : SD card could be switched to 4-bit mode for better throughput
Text Notes 6050 800  0    60   ~ 12
NB: VSPI is used for SD card and re-assigned to different GPIO.\nThis limits the bus frequency to ~~26MHz instead of 80MHz
Wire Wire Line
	6950 3150 7550 3150
NoConn ~ 4550 2650
...
$EndComp
$Comp
L KXKM_audio_battery_module-rescue:GND #PWR0109
U 1 1 5CB8E7AB
P 10000 5400
...
$EndComp
$Comp
L KXKM_audio_battery_module-rescue:VBUS #PWR0110
U 1 1 5CB9730E
P 10000 5850
